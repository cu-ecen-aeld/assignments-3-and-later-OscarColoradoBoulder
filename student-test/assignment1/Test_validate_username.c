...
void test_validate_my_username()
{
	...
	TEST_ASSERT_NOT_NULL_MESSAGE(actual, "Returned string from conf file is NULL");
	TEST_ASSERT_EQUAL_STRING_MESSAGE(expected, actual, "Username does not match expected value");
